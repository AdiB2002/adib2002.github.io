    ...
    handler: () => {
      window.location.href = "/";
        ...
        handler: () => {
          ...
          description: "",
          section: "News",},{id: "news-excited-to-be-joining-professor-andrew-head-s-lab-as-a-research-assistant-this-summer",
          title: 'Excited to be joining Professor Andrew Head’s lab as a research assistant this...',
          description: "",
        ...
        section: 'Socials',
        handler: () => {
          window.open("mailto:%61%61%64%69%74%62%61%72%75%61@%75%74%65%78%61%73.%65%64%75", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/AdiB2002", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/aaditbarua", "_blank");
        },
      },{
        id: 'social-scholar',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://scholar.google.com/citations?user=QbvGu3AAAAAJ", "_blank");
        },
      },{
      id: 'light-theme',
